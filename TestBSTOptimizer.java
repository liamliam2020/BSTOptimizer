...
/// Date:     October 2018
///
/*  Edited by: B. Liam Rethore
    Last Edited On: 11/05/2019

    Changes from Orginal Driver:
    1.  My cost function needs to be called like so: BinaryTreeObject.cost()
        while it was orginally called like BinaryTreeObject.cost by Dr. Aronis.

    2.  My toString method works like a regular toString and needs to 
        be called like BinaryTreeObject.toString(). This then needs to be passed
        to any print function as the toString returns a unprinted string.

    ...I think thats the only differences between our drivers :) 
*/
...
public class TestBSTOptimizer {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(bestBST.toString());
    System.out.printf( "  Cost: %d", bestBST.cost()) ;
